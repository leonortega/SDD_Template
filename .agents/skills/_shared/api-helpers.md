...
`.agents/skills/openproject-sprint-backlog/references/openproject-api.md`.
...
ignored `.template/agent-telemetry.local.jsonl`.
...
`.agents/skills/_shared/pipeline-workflow-telemetry.md`). It resolves the activity, builds this payload, POSTs it, and
