...
`.agents/skills/_shared/test-requirements.md` for the complete level definitions, scope rules, folder structure, and
examples.
...
- `.agents/skills/_shared/test-requirements.md` — Test level definitions and examples
- `.agents/skills/tdd/SKILL.md` — Full TDD skill rules
