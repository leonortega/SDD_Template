...
skills apply ALWAYS comes from the internet — local skills and `.agents/skills/manifest.json` are NEVER consulted to
...
level 5).
- **Never answer guidance from local skills.** `.agents/skills/manifest.json` and installed skills exist only for
