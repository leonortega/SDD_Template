...
Follow `.agents/skills/_shared/skill-startup.md` for the tiered read order. This skill owns updates to
`docs/` and `knowledge/`; authoritative findings belong in `docs/`, enforceable automation belongs in
`.agents/skills/_shared/delivery-contract.md` plus affected skills and tests, and reusable
...
If a finding is enforceable automation behavior, update `.agents/skills/_shared/delivery-contract.md`
...
2. **Classify the finding** — start from the classifier's candidate list and confirm or refine the
   ...
   `.agents/skills/_shared/delivery-contract.md` plus affected skills and tests; reusable
