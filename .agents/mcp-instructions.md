...
- OpenProject MCP uses the community `openproject-mcp` package (read/write)
  - Cross-ref API adapter at
    `.agents/skills/openproject-sprint-backlog/references/openproject-api.md` for direct REST API calls
...
`.agents/skills/_shared/delivery-contract.md` — and overrides ad hoc service-interaction decisions.
