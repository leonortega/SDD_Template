...
namespace SDDTemplate.DeliveryTools.Tests
{
    public sealed class DeploymentWorkflowTests
    {
        ...
        public void ConfigInfraRequiresProjectProfileInitializationBeforeProviderSetup()
        {
            ...
            Assert.Contains("InitProjectProfile -> EnsureRancherKubernetes when Rancher Desktop is selected -> Audit -> Plane", configureRouter);
            ...
            Assert.Contains("follow its `InitProjectProfile`, `EnsureRancherKubernetes` when Rancher Desktop is selected, audit", compatibilityRouter);
