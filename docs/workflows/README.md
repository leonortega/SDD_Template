...
All 22 routing rows now have eval coverage: the Promptfoo eval
(`.agents/agent-evals/promptfooconfig.yaml`, 61 cases — see `.agents/agent-evals/README.md` for
the authoritative count) exercises every explicit
