...
- Local Docker Compose infrastructure provides Plane, Gitea, the Gitea Actions runner, Nexus, Dozzle, Prometheus, Loki, Grafana Alloy, and Grafana.
...
- Prometheus and Grafana provide local infrastructure and Azure application health visibility; Grafana Alloy collects Azure Event Hubs logs into Loki for environment-specific Grafana log boards; Dozzle provides local container log inspection.
