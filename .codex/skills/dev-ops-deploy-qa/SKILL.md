...
11. Confirm Nexus contains `app/{commitSha}/deployment-config.json`. Treat a missing deployment configuration artifact as blocking workflow drift and route to `configure-cloud-environments`.
