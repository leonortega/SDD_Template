...
`.codex/skills/_shared/delivery-contract.md`: implementation must create committed
automated coverage for every acceptance criterion before product-code handoff, then use vertical RED/GREEN cycles.

## Shared Context

Before applying TDD inside this repository, follow `.codex/skills/_shared/skill-startup.md`, read
