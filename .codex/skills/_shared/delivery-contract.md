...
- `RenderOpenProjectTimeTelemetryComment` and `ReadOpenProjectTimeTelemetry`: render and read OpenProject time-entry telemetry comments for the primary workflow timing path.
