...
The command reads `.codex/client-tools.local.json`
...
See `.codex/skills/_shared/pipeline-review-handoff.md` for the full reviewer
...
- `.codex/skills/_shared/pipeline-review-handoff.md` — detailed reviewer
  request pattern (Step 2 / Step 6 mechanics)
- `.codex/skills/dev-flow-pr-review-agent/SKILL.md` — the AI review (Step 3)
- `.codex/skills/dev-flow-pr-review-feedback-loop/SKILL.md` — the feedback
  loop (Step 4)
- `.gitea/workflows/pr-validation.yml` — the CI gate (Step 5)
- `.codex/skills/_shared/pipeline-ticket-comment.md` — ticket comment
  verification pattern (Step 1 / Step 7)
- `.codex/skills/_shared/delivery-contract-review.md` — review-stage rules
