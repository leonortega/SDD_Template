...
- For non-parallel workflows, use `.codex/client-tools.local.json.openRouter.defaultChatModel` with optional per-skill
...
`.codex/client-tools.local.json`, `.codex/project-profile.local.json`, `.codex/quality.local.json`, and
