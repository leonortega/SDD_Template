...
`.codex/skills/*/SKILL.md` files and exact paths for delegation.
...
`.codex/delivery-context.local.json` as the local active delivery context lock. Never commit it. Do not delete
