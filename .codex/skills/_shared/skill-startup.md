...
4. `.codex/delivery-policy.json`
5. `docs/context-management.md`
6. Stage-specific docs named by the skill, such as `docs/architecture.md`, `docs/development.md`, or `docs/deployment.md`
...
- Apply `.codex/delivery-policy.json` for ticket key format and `agentOptimization` defaults such as retry limits, prompt-cache ordering, telemetry output, and workflow eval paths when the platform exposes the needed data.
