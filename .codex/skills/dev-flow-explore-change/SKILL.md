...
Stop or redirect when the user asks for implementation, the ticket context is ambiguous, required evidence cannot be inspected, or exploration would mutate repo-tracked state without explicit artifact-capture intent.
